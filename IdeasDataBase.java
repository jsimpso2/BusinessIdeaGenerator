...
public  class IdeasDataBase {
    ...
    public static BusinessIdea[] getIdeas()
    {
        ...
        businessIdea[3]=new BusinessIdea("Online Library",6,"Online library, one of the powerful education business platforms useful for both children and adults to spend their free time.",true,800,true);
        businessIdea[4]=new BusinessIdea("Fashion Design Institute",8,"Both men and women have a huge love for fashion designing thus a profitable business",true,600,false);
        businessIdea[5]=new BusinessIdea("Online Music School",9," By launching an online music school, you can easily monetize your music expertise.",false,700,false);
        businessIdea[6]=new BusinessIdea("Photography ",4,"Photography, one of the perfect business ideas for driving income.",false,500,true);
        businessIdea[7]=new BusinessIdea("Real estate",10,"Renting and selling properties",true,1200,false);
        ...
        businessIdea[11]=new BusinessIdea("Freelancer",8,"Becoming a freelancer requires you to have a skill that is in demand and monetizable.",true,0,true);
        businessIdea[12]=new BusinessIdea("Car Wash",7,"Car washing services are sought out.",true,600,false);
